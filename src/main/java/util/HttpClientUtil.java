...
public class HttpClientUtil {  
    public String doPost(String url,Map<String,String> map,String charset,String content){  
        ...
        try{  
            ...
            httpClient.getParams().setIntParameter(CoreConnectionPNames.SO_TIMEOUT, 4000);
            httpClient.getParams().setIntParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, 4000);
            ...
            //ex.printStackTrace();  
            System.out.println("error when post " + content);
        }finally {
